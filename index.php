            ...
            <div class="auth-box row">
                ...
                <div class="col-lg-5 col-md-7 bg-white">
                    <div class="p-3">
                        ...
                        <p class="text-center">BIRTH AND DEATH REGISTRATION SYSTEM.</p>
                        <form class="mt-4" action="tools/ch_login.php" method="post">
                            <div class="row">
                                <div class="col-lg-12">
                                ...
                                <div class="col-lg-12 text-center">
                                    <button type="submit" class="btn w-100 btn-dark">Loging</button>
                                </div>
                                <div class="col-lg-12 text-center mt-5">
                                    Powered by <a href="#" class="text-danger">Group A</a>
                                </div>
                            </div>
                        </form>
                    </div>
